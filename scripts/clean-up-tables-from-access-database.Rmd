...
```{r load all packages}
source(file.path(currentwd, "scripts", "packages.R"))
```

```{r load custom functions}
source(file.path(currentwd, "scripts", "functions.R"))
```

## 1.0 Load Data

```{r add file path}
path_to_excel_file <- file.path(currentwd,
                                "data", "adaptive_management_documents_asessment_export_all_tables_from_access.xlsx")
...
```{r}
AdatManDesc_duplicate_variables <- all_excel_sheets$tblAdaptManDesc_doc %>% 
  dplyr::group_by(AdaptManDesc) %>% 
  dplyr::count()
```

```{r}
print(AdatManDesc_duplicate_variables)
```


```{r eval=FALSE, include=FALSE}
openxlsx::write.xlsx(AdatManDesc_duplicate_variables, 
                     file = file.path(currentwd, "data", "17-AdaptManDesc-duplicate-variables.xlsx")
                     )
```
...
# path_to_excel_file <- file.path(currentwd, "data", "16-full-join-tblAllotmentKeySpecies-tblDocSpecs.xlsx")
# 
# sheet_names <- openxlsx::getSheetNames(path_to_excel_file)
# 
# all_excel_sheets <- lapply(sheet_names, openxlsx::read.xlsx, xlsxFile = path_to_excel_file)
# 
# names(all_excel_sheets_list) <- sheet_names
```
...
all_excel_sheets$tblAdaptManDesc_doc$AdaptManDesc <- 
all_excel_sheets$tblAdaptManDesc_doc$AdaptManDesc %>%
stringr::str_replace_all(pattern = "Best Practices; Flexible Use; Learning and Monitoring",
                         replacement = "Best Practices; Learning and Monitoring; Flexible Use")
```
...
all_excel_sheets$tblAdaptManDesc_doc$AdaptManDesc <- 
all_excel_sheets$tblAdaptManDesc_doc$AdaptManDesc %>%
stringr::str_replace_all(pattern = "Trial/Error; Flexible Use; Learning and Monitoring",
                         replacement = "Flexible Use; Learning and Monitoring; Trial/Error")
```
...
all_excel_sheets$tblAdaptManDesc_doc$AdaptManDesc <- 
all_excel_sheets$tblAdaptManDesc_doc$AdaptManDesc %>%
stringr::str_replace_all(pattern = "Trial/Error; Flexible Use",
                         replacement = "Flexible Use; Trial/Error")
```
...
all_excel_sheets$tblAdaptManDesc_doc$AdaptManDesc <- 
all_excel_sheets$tblAdaptManDesc_doc$AdaptManDesc %>%
stringr::str_replace_all(pattern = "Learning and Monitoring; Trial/Error; Flexible Use",
                         replacement = "Learning and Monitoring; Flexible Use; Trial/Error")
```
...
all_excel_sheets$tblAdaptManDesc_doc$AdaptManDesc <- 
all_excel_sheets$tblAdaptManDesc_doc$AdaptManDesc %>%
stringr::str_replace_all(pattern = "Triggers; Flexible Use",
                         replacement = "Flexible Use; Triggers")
```
...
```{r eval=FALSE, include=FALSE}
openxlsx::write.xlsx(all_excel_sheets, 
                     file = file.path(currentwd, "data", "18-AdaptManDesc-cleaned-duplicate-variables.xlsx")
                     )
```

```{r}
AdatManDesc_cleaned_variables <- all_excel_sheets$tblAdaptManDesc_doc %>% 
  dplyr::group_by(AdaptManDesc) %>% 
  dplyr::count()
```

```{r eval=FALSE, include=FALSE}
openxlsx::write.xlsx(AdatManDesc_cleaned_variables, 
                     file = file.path(currentwd, "data", "19-AdaptManDesc-cleaned-summarized-variables.xlsx")
                     )
```
...
```{r}
all_excel_sheets$tblDocSpecs <- 
dplyr::full_join(all_excel_sheets$tblDocSpecs,
  all_excel_sheets$tblAdaptManDesc_doc,
  by = c("intDocNo" = "DocNo"))
```
...
```{r}
openxlsx::write.xlsx(all_excel_sheets, 
                     file = file.path(currentwd, "data", "20-full-join-tblDocSpecs-tblAdaptManDesc.xlsx")
                     )
```
