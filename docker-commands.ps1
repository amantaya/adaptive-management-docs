...
docker run -d -e DISABLE_AUTH=true --rm -p 127.0.0.1:80:8787 -v C:/Users/andre/Dropbox/Dev/adaptive-management-docs:/home/rstudio/adaptive-managements-docs amantaya/verse:4.1.3
